...
const Sucursal = () => {
    ...
    const onInputChange = (e, sucu_Id) => {
        const val = (e.target && e.target.value) || '';
        let _product = { ...product };
        _product[`${sucu_Id}`] = val;

        setProduct(_product);
    };

    const onInputNumberChange = (e, sucu_Id) => {
        const val = e.value || 0;
        let _product = { ...product };
        _product[`${sucu_Id}`] = val;
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        emptyMessage="No hay Sucursal."
                        header={header}
                        responsiveLayout="scroll"
                    >
                        <Column selectionMode="multiple" headerStyle={{ width: '4rem' }}></Column>
                        <Column field="Id" header="ID" sortable body={codeBodyTemplate} headerStyle={{ minWidth: '5rem' }}></Column>
                        <Column field="Sucursal" header="Sucursal" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="Direccion" header="Direccion" sortable body={AddressBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
