            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="Usuario" header="Usuario" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="Nombre" header="Nombre" sortable body={EmpleadoBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
