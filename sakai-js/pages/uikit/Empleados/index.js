...
const Empleados = () => {
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Empleadosss</h5>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="DNI" header="DNI" sortable body={codeBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="Nombre" header="Nombre" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="Apellido" header="Apellido" sortable body={ApellidoBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="Cargo" header="Cargo" sortable body={CargoBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="Sucursal" header="Sucursal" sortable body={SucursalBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
