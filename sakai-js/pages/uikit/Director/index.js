    ...
    const ApellidoBodyTemplate = (rowData) => {
        return (
            <>
                ...
                {rowData.dire_Apellidos}
            </>
        );
    };
    const BornBodyTemplate = (rowData) => {
        return (
            <>
                <span className="p-column-title">Fecha De Nacimiento</span>
                {rowData.dire_FechaNacimiento}
            </>
        );
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >   
                        ...
                        <Column field="Nacimiento" header="Nacimiento" sortable body={BornBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
